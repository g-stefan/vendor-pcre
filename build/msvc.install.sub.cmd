...
xcopy /Y /S /E "temp\pcre\bin\*.exe" "%INSTALL_PATH_BIN%\"
xcopy /Y /S /E "temp\pcre\bin\*.dll" "%INSTALL_PATH_BIN%\"
...
xcopy /Y /S /E "temp\pcre\bin\*.exe" "%INSTALL_PATH_DEV%\bin\"
xcopy /Y /S /E "temp\pcre\bin\*.dll" "%INSTALL_PATH_DEV%\bin\"
xcopy /Y /S /E "temp\pcre\include\" "%INSTALL_PATH_DEV%\include\"
copy /Y /B "temp\pcre\lib\*.lib" "%INSTALL_PATH_DEV%\lib\*"
