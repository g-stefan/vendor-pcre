...
call :cmdX xyo-cc --mode=%ACTION% --source-has-archive pcre
...
SET CMD_CONFIG=%CMD_CONFIG% -DCMAKE_INSTALL_PREFIX=%WORKSPACE_PATH_BUILD%\pcre
SET CMD_CONFIG=%CMD_CONFIG% -DBUILD_SHARED_LIBS=ON
